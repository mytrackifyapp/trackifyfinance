...
export function PersonalAccountingView({ accounts, transactions }) {
    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
          <h2 className="text-xl sm:text-2xl font-bold">Personal Accounts</h2>
          ...
          <CreateAccountDrawer>
            <Card className="hover:shadow-md transition-shadow cursor-pointer border-dashed">
              <CardContent className="flex flex-col items-center justify-center text-muted-foreground h-full pt-5 min-h-[150px]">
                ...
                <p className="text-sm font-medium">Add Personal Account</p>
              </CardContent>
            </Card>
          </CreateAccountDrawer>
          {accounts.length > 0 &&
